   ...
   public class Ecir
    {
      ...
      public static  Color color = Color.White;
        ...
        public void TerrainColisions()
        {
            ...
            // lateral colisions 
            Rectangle lateralTerrain0 = new Rectangle(-338, 302, 0, 300);
            ...
            Rectangle lateralTerrain1_25_1 = new Rectangle(2602, 302, 0, 300);
            ...
            Rectangle lateralTerrain1_29 = new Rectangle(3400, 59, 0, 400);
            Rectangle lastCol = new Rectangle(4394, -200, 0, 300);
            if (this.Rectangle.Intersects(lateralTerrain0)) EcirVelocity(2, 0);
            ...
            if (this.Rectangle.Intersects(lastCol)) { EcirVelocity(-2, 0); }
       ...
       public void EcirLife() {//vida do ecir, este sofre dano pelos inimigos
            ...
            if (HollowKnight.listHollowKnight[HollowKnight.index] != null)
            {
                ...
                {   if(countTime==false)
                    ...
                    if (time >= 0.5 && takeLife==true)// Hollow knight para e ataca
                    {
                        color = Color.Red;
                        life = life - 40;
                        takeLife = false;
                ...
                if (time >= 0.9)//quando para para atacar mas o jogador foge então o encir continua a andar
                {
                    HollowKnight.listHollowKnight[HollowKnight.index].VelocityX = 2;
                    hollowKnightTouch = false; 
                   // killTime = false;
            ...
            if (Ogre.listOgre[Ogre.index] != null)
            {
                ...
                {   if (countTimeOgre == false)
                    ...
                    if (time >= 1.1 && takeLifeOgre == true)// ogre  para e ataca
                    {
                        color = Color.Red;
                        life = life - 60;
                        takeLifeOgre = false;
